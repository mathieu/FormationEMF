 ...
 * @generated
 */
public class RelationnelPackageImpl extends EPackageImpl implements RelationnelPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see fr.obeo.formation.emf2.relationnel.RelationnelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private RelationnelPackageImpl() {
		super(eNS_URI, RelationnelFactory.eINSTANCE);
	}
	 ...
	 * @generated
	 */
	public static RelationnelPackage init() {
		if (isInited) return (RelationnelPackage)EPackage.Registry.INSTANCE.getEPackage(RelationnelPackage.eNS_URI);

		// Obtain or create and register package
		RelationnelPackageImpl theRelationnelPackage = (RelationnelPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof RelationnelPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new RelationnelPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theRelationnelPackage.createPackageContents();

		// Initialize created meta-data
		theRelationnelPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theRelationnelPackage.freeze();

		return theRelationnelPackage;
	}
	 ...
	 * @generated
	 */
	public EAttribute getDatabase_Uri() {
	 ...
	 * @generated
	 */
	public RelationnelFactory getRelationnelFactory() {
		return (RelationnelFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(databaseEClass, DATABASE__URI);
