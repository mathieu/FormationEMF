...
/**
 * This is the item provider adapter for a {@link fr.obeo.formation.emf2.relationnel.iface.Table} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TableItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RelationnelPackage.Literals.TABLE__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RelationnelPackage.Literals.TABLE__FIELDS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RelationnelPackage.Literals.TABLE__FIELDS,
				 RelationnelFactory.eINSTANCE.createPrimaryKey()));

		newChildDescriptors.add
			(createChildParameter
				(RelationnelPackage.Literals.TABLE__FIELDS,
				 RelationnelFactory.eINSTANCE.createForeignKey()));

		newChildDescriptors.add
			(createChildParameter
				(RelationnelPackage.Literals.TABLE__FIELDS,
				 RelationnelFactory.eINSTANCE.createColumn()));
	}
