...
public class ColumnItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RelationnelPackage.Literals.COLUMN__TYPE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		String type = ((Column)object).getType().getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Column_type") : type == null || type.length() == 0 ?
			getString("_UI_Column_type") + " " + label : getString("_UI_Column_type") + " " + label + " " + type;
	}
