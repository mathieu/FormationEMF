...
public class DatabaseItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_Database_uri_description"),
				 RelationnelPackage.Literals.DATABASE__URI,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RelationnelPackage.Literals.DATABASE__PORT,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RelationnelPackage.Literals.DATABASE__SCHEMAS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Database.class)) {
			case RelationnelPackage.DATABASE__URI:
			case RelationnelPackage.DATABASE__PORT:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case RelationnelPackage.DATABASE__SCHEMAS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RelationnelPackage.Literals.DATABASE__SCHEMAS,
				 RelationnelFactory.eINSTANCE.createSchema()));
	}
	...
	public ResourceLocator getResourceLocator() {
		return RelationnelEditPlugin.INSTANCE;
	}
