...
import fr.obeo.taining.relational.iface.Table;
...
/**
 * This is the item provider adapter for a {@link fr.obeo.taining.relational.iface.Table} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TableItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RelationalPackage.Literals.TABLE__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RelationalPackage.Literals.TABLE__FIELDS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Table.class)) {
			case RelationalPackage.TABLE__NAME:
				...
				return;
			case RelationalPackage.TABLE__FIELDS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RelationalPackage.Literals.TABLE__FIELDS,
