 ...
 * $Id$
 */
package fr.obeo.taining.relational.provider;
...
/**
 * This is the item provider adapter for a {@link fr.obeo.taining.relational.iface.DataBase} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataBaseItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataBase_uri_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataBase_uri_feature", "_UI_DataBase_type"),
				 RelationalPackage.Literals.DATA_BASE__URI,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RelationalPackage.Literals.DATA_BASE__SCHEMAS);
		}
	...
	public String getText(Object object) {
		String label = ((DataBase)object).getUri();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RelationalPackage.Literals.DATA_BASE__SCHEMAS,
