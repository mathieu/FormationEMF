...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>relationnel</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class RelationnelExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(RelationnelPackage.eNS_URI, 
			 RelationnelPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.relationnel"));
				Database root = RelationnelFactory.eINSTANCE.createDatabase();
