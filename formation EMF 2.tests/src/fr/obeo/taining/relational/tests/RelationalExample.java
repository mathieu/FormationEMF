...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>relational</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class RelationalExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.relational"));
				DataBase root = RelationalFactory.eINSTANCE.createDataBase();
